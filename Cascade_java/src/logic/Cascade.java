...
// ***** VDMTOOLS START Name=CalculateScore#1|Number KEEP=NO
  public Number CalculateScore (final Number n_blocks) throws CGException {
...
// ***** VDMTOOLS START Name=pre_CalculateScore#1|Number KEEP=NO
  public Boolean pre_CalculateScore (final Number n_blocks) throws CGException {
...
// ***** VDMTOOLS START Name=post_CalculateScore#2|Number|Number KEEP=NO
  public Boolean post_CalculateScore (final Number n_blocks, final Number RESULT) throws CGException {
...
// ***** VDMTOOLS START Name=insertLine KEEP=NO
  public void insertLine () throws CGException {
    sentinel.entering(((CascadeSentinel)sentinel).insertLine);
    try {
      if (!this.pre_insertLine().booleanValue()) 
        UTIL.RunTime("Precondition failure in insertLine");
      if (board.willFinish().booleanValue()) 
        endGame();
      else 
        board.insertNewLine();
    }
    finally {
      sentinel.leaving(((CascadeSentinel)sentinel).insertLine);
    }
  }
// ***** VDMTOOLS END Name=insertLine


// ***** VDMTOOLS START Name=pre_insertLine KEEP=NO
  public Boolean pre_insertLine () throws CGException {
    return isPlayable;
  }
// ***** VDMTOOLS END Name=pre_insertLine
